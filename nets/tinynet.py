...
def tinynet(images, num_classes=43, is_training=False,
...
tinynet.default_image_size = 32


def tinynet_arg_scope(weight_decay=0.004):
    ...
    with slim.arg_scope(
            [slim.conv2d, tinyconv2d.conv2d_tiny],
